...
String GAS_ID = "YourGoogleAppsScriptAPIKey";
...
void loop() {
 ...
 if (h >= 75) {
   ...
   String url1 = "/trigger/Humidity_Alert/with/key/YourIFTTTAPIKey";
 ...
 if (t >= 35) {
   ...
   String url2 = "/trigger/Temp_Alert/with/key/YourIFTTTAPIKey";
   Serial.print("Requesting URL: ");
   Serial.println(url2);
 ...
 if (level <= 100) {
   ...
   String url3 = "/trigger/Low_supplement/with/key/YourIFTTTAPIKey";
   Serial.print("Requesting URL: ");
   Serial.println(url3);
